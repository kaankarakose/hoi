...
def main():
    ...
    # Configuration
    parser.add_argument("--activeness-threshold", type=float, default=0.1, help="Activeness threshold (0-1)")
    parser.add_argument("--energy-threshold", type=float, default=0.1, help="Energy threshold (0-1)")
