...
from inference_wrapper_new  import InferenceWrapper
import glob
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="/nas/project_data/B1_Behavior/rush/kaan/hoi/processed_data/cnos_hand_wo_merging",
