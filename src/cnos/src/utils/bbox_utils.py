...
class CropResizePad:
    ...
    def __call__(self, images, boxes):
        ...
        for image, box, scale in zip(images, boxes, scale_factor):
            ...
            new_h = max(14, (new_h // 14) * 14)  # Ensure minimum height is 14
            new_w = max(14, (new_w // 14) * 14)  # Ensure minimum width is 14
            ...
            # No need for final resize since we've padded to exact target dimensions
            processed_images.append(image)
